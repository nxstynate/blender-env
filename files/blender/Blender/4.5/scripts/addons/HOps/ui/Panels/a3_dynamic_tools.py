...
class HOPS_PT_DynamicToolsPanel(bpy.types.Panel):
    ...
    def draw_edit_mode_menu(self, layout, object):
        ...
        #layout.operator("hops.clean1_objects", text="Clean SSharps", icon_value = get_icon_id("CleansharpsE")).clearsharps = True
        layout.separator()
        layout.operator("hops.clean1_objects", text="Demote", icon_value=get_icon_id("CleansharpsE")).clearsharps = False
        layout.separator()
