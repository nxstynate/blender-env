...
class HOPS_OT_AddMaterials(bpy.types.Operator):
    ...
    def execute(sefl, context):
        ...
        bpy.ops.hops.display_notification(info='Ngon/Tri Display', subtext="Tris/Ngons/Quads Displayed")
        return {'FINISHED'}
...
class HOPS_OT_RemoveMaterials(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        updateDisplayColor(context.scene)
        bpy.ops.hops.display_notification(info='Ngon/Tri Display Off', subtext="Toggled Display")
        return {'FINISHED'}
