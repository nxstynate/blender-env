...
CTRL - Planar Smart Box
    ...
    def invoke(self, context, event):
        ...
        if addon.preference().behavior.add_mirror_to_boolshapes:
        ...
        # if addon.preference().behavior.add_WN_to_boolshapes:
    ...
    def add_weighted_modifier(self, object, name='HOPS_weighted'):
        ...
        modifier = object.modifiers.new(f'{prefix}WeightedNormal', 'WEIGHTED_NORMAL')
