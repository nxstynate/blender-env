...
from .user import (PoliigonSubscription,
                   PoliigonUser,
                   SubscriptionState)
from .user import UserDownloadPreferences
...
class ApiJobParamsGetUserData(ApiJobParams):
    ...
    def finish(self, api_rc, job) -> None:
        ...
        api_rc.add_job_get_download_prefs(
            ...
            callback_done=api_rc._addon_params.callback_get_download_prefs_done,
            force=True)
...
class ApiJobParamsGetDownloadPrefs(ApiJobParams):
    ...
    def thread_execute(self, api_rc, job) -> None:
        ...
        if api_rc._addon.user is None:
            api_rc.logger.error("User not defined when fetching Download preferences.")
            return
    ...
    def finish(self, api_rc, job) -> None:
        ...
        api_rc._addon.user.map_preferences = UserDownloadPreferences(map_preferences)
