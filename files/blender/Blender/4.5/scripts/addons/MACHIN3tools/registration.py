...
keys = {'SMART_VERT': [{'label': 'Merge Last', 'keymap': 'Mesh', 'idname': 'machin3.smart_vert', 'type': 'ONE', 'value': 'PRESS', 'properties': [('mode', 'MERGE'), ('mergetype', 'LAST'), ('slideoverride', False)]},
        ...
        'FILEBROWSER': [{'label': 'Open Filebrowser', 'keymap': 'File Browser', 'space_type': 'FILE_BROWSER', 'idname': 'machin3.filebrowser_open', 'type': 'O', 'value': 'PRESS', 'properties': [('blend_file', False)]},
                        ...
                        {'label': 'Adjust Thumbnail Size', 'keymap': 'File Browser', 'space_type': 'FILE_BROWSER', 'idname': 'machin3.filebrowser_adjust_thumbnail_size', 'type': 'THREE', 'value': 'PRESS', 'properties': [('reverse', False)]},
                        {'label': 'Adjust Thumbnail Size (Down)', 'keymap': 'File Browser', 'space_type': 'FILE_BROWSER', 'idname': 'machin3.filebrowser_adjust_thumbnail_size', 'type': 'THREE', 'value': 'PRESS', 'shift': True, 'properties': [('reverse', True)]},
