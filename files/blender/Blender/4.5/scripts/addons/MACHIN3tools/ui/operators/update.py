...
class RemoveUpdate(bpy.types.Operator):
    bl_idname = "machin3.remove_machin3tools_update"
...
class UseFoundUpdate(bpy.types.Operator):
    bl_idname = "machin3.use_machin3tools_update"
    ...
    def description(cls, context, properties):
        return f"Install MACHIN3tools {properties.tail} from {properties.path}"
...
class ReScanUpdates(bpy.types.Operator):
    bl_idname = "machin3.rescan_machin3tools_updates"
