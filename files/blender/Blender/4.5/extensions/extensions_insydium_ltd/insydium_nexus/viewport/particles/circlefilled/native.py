...
"""Native (Vulkan / Metal) circle filled renderer — indirect binned path."""

from __future__ import annotations

from ..native_base import NativeParticleBase

_CIRCLE_FILLED_MODE_INDEX = 6


class CircleFilledNativeRenderer(NativeParticleBase):
    def draw(self, context, pipeline, scene, params) -> bool:
        ...
        bridge.stage_display_shape(2, 2, 0, params.size, params.size)
        bridge.stage_indirect_mode(_CIRCLE_FILLED_MODE_INDEX)
