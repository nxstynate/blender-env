...
"""Native (Vulkan / Metal) circle outline renderer — indirect binned path."""

from __future__ import annotations

from ..native_base import NativeParticleBase

_CIRCLE_MODE_INDEX = 5


class CircleNativeRenderer(NativeParticleBase):
    def draw(self, context, pipeline, scene, params) -> bool:
        ...
        bridge.stage_display_shape(2, 1, 0, params.size, params.size)
        bridge.stage_indirect_mode(_CIRCLE_MODE_INDEX)
