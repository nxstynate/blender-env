...
"""Native (Vulkan / Metal) square renderer — indirect binned path."""

from __future__ import annotations

from ..native_base import NativeParticleBase

_SQUARE_MODE_INDEX = 1


class SquareNativeRenderer(NativeParticleBase):
    def draw(self, context, pipeline, scene, params) -> bool:
        ...
        bridge.stage_display_shape(1, 0, 0, params.size, params.size)
        bridge.stage_indirect_mode(_SQUARE_MODE_INDEX)
