...
"""Native (Vulkan / Metal) direction-line renderer — indirect binned path."""

from __future__ import annotations

from ..native_base import NativeParticleBase

_DIRECTION_MODE_INDEX = 2


class DirectionNativeRenderer(NativeParticleBase):
    def draw(self, context, pipeline, scene, params) -> bool:
        ...
        bridge.stage_display_shape(3, 0, 0, 0.0, line_scale, mode)
        bridge.stage_indirect_mode(_DIRECTION_MODE_INDEX)
