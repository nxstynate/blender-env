...
"""Native (Vulkan / Metal) point renderer."""

from __future__ import annotations

from ..native_base import NativeParticleBase

_POINTS_MODE_INDEX = 0


class PointNativeRenderer(NativeParticleBase):
    def draw(self, context, pipeline, scene, params) -> bool:
        ...
        bridge.stage_display_shape(0, 0, 0, params.size, params.size)
        bridge.stage_indirect_mode(_POINTS_MODE_INDEX)
