...
class AddMeshExtraObjectsPreferences(bpy.types.AddonPreferences):
    ...
    show_rocks_generator: bpy.props.BoolProperty(
        name = "Show Rocks Generator",
        default = True,
    )
    ...
    show_diamonds: bpy.props.BoolProperty(
        name = "Diamonds (Menu)",
        default = True,
    )
    ...
    def draw(self, context):
        ...
        col.prop(self, "show_rocks_generator")
